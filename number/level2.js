...
// Q1. Calculate the average of a, b, and c.

let average = (a + b + c) / 3;
console.log(average);

// Q2. Calculate the square root of 25.

let sqrtValue = Math.sqrt(25);
console.log(sqrtValue);

// Q3. Calculate the difference between 998 and 678

let difference = 998 - 678;
console.log(difference);

// Q4. Find the largest number among a, b, and c

let largest = Math.max(a, b, c);
console.log(largest);

// Q5. Calculate the result of (a + b) divided by (c + 1).
